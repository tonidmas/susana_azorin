...
async function generarContratoDocx(tenant, refCatastral) {
...
function TenantFormModal({ tenant, onCancel, onSave, notify, onViewDoc, selectedMonth, refCatastral, onGenerarRecibo }) {
  ...
  async function handleGenerarContrato() {
    ...
    try {
      await generarContratoDocx(form, refCatastral);
