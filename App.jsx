...
const GlobalStyles = () => (
  <style>{`
    ...
    .rg-nav-scroll { display: contents; }

    @media (max-width: 800px) {
      .rg-shell { flex-direction: column; }
      .rg-sidebar { width: 100%; flex-direction: row; align-items: center; padding: 12px; }
      .rg-brand { padding: 0 10px 0 0; flex-shrink: 0; }
      .rg-nav-scroll {
        display: flex; flex-direction: row; align-items: center; gap: 4px;
        overflow-x: auto; flex: 1 1 auto; min-width: 0;
      }
      .rg-nav-scroll .rg-nav-item { flex-shrink: 0; }
      .rg-sidebar-footer { margin-top: 0; padding: 0; flex-shrink: 0; display: flex; align-items: center; }
      .rg-sidebar-footer-info { display: none; }
      .rg-logout-btn {
        display: flex; align-items: center; gap: 5px; flex-shrink: 0; white-space: nowrap;
        width: auto; height: auto;
        border: 1px solid var(--border); border-radius: 8px; padding: 8px 10px; color: var(--danger);
      }
