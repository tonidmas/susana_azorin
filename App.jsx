...
function buildEmptySegundaVivienda() {
  return {
    datos: { nombre: "", telefono: "", correo: "", fechaInicio: "", fechaFinContrato: "", renta: "" },
    meses: {}
  };
}
...
function segundaIngresosForMonth(segunda, ym) {
  ...
  if (!m.fechaPagoRenta) return 0;
  return Number(segunda.datos?.renta) || 0;
}
  ...
  return (
    <>
      ...
      <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
        ...
        <div className="rg-form-grid">
          ...
          <div className="rg-field">
            ...
            <input className="rg-input" type="number" min="0" step="0.01" value={datos.renta ?? ""} onChange={(e) => onUpdateDatos({ renta: e.target.value === "" ? "" : Number(e.target.value) })} placeholder="0" />
          </div>
          <div className="rg-field">
            <label className="rg-label">Fecha de inicio de contrato</label>
            <input className="rg-input" type="date" value={datos.fechaInicio || ""} onChange={(e) => onUpdateDatos({ fechaInicio: e.target.value })} />
          </div>
          <div className="rg-field">
            <label className="rg-label">Fecha de fin de contrato</label>
            <input className="rg-input" type="date" value={datos.fechaFinContrato || ""} onChange={(e) => onUpdateDatos({ fechaFinContrato: e.target.value })} />
          </div>
        </div>
      </div>
      ...
      <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
        ...
        <div className="rg-form-grid">
          <div className="rg-field">
            <label className="rg-label">Fecha de pago de la renta</label>
            <input className="rg-input" type="date" value={mes.fechaPagoRenta || ""} onChange={(e) => onUpdateMes(selectedMonth, { fechaPagoRenta: e.target.value })} />
          </div>
          <div />
          <div className="rg-field">
          ...
          <div className="rg-field">
            <label className="rg-label">Luz — fecha de pago</label>
            <input className="rg-input" type="date" value={mes.fechaPagoLuz || ""} onChange={(e) => onUpdateMes(selectedMonth, { fechaPagoLuz: e.target.value })} />
          </div>
          <div className="rg-field">
          ...
          <div className="rg-field">
            <label className="rg-label">Agua — fecha de pago</label>
            <input className="rg-input" type="date" value={mes.fechaPagoAgua || ""} onChange={(e) => onUpdateMes(selectedMonth, { fechaPagoAgua: e.target.value })} />
          </div>
        </div>
      ...
      <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
        ...
        <div className="rg-form-grid">
          ...
          <div className="rg-field">
            <label className="rg-label">IBI — fecha de pago</label>
            <input className="rg-input" type="date" value={mes.ibiFecha || ""} onChange={(e) => onUpdateMes(selectedMonth, { ibiFecha: e.target.value })} />
          </div>
        </div>
