    ...
    <div className="rg-root" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", padding: 20 }}>
      ...
      <form className="rg-card rg-login-card" onSubmit={handleSubmit}>
        <div className="rg-brand" style={{ marginBottom: 22, padding: 0 }}>
          ...
          <div>
            <div className="rg-display" style={{ fontSize: 18, fontWeight: 700, lineHeight: 1 }}>Alquilum</div>
      ...
      <div className="rg-shell">
        ...
        <div className="rg-sidebar">
          <div className="rg-brand">
            <div className="rg-brand-mark"><KeyRound size={18} /></div>
            <div>
              <div className="rg-display" style={{ fontSize: 16, fontWeight: 700, lineHeight: 1 }}>Alquilum</div>
...
function GastosView({ selectedMonth, monthLabel, shiftMonth, expenses, updateExpenseField, incomeForMonth, fixedExpensesForMonth, managementFeeForMonth, totalExpensesForMonth, netProfitForMonth, yearData, selYear, onUploadFactura, onDeleteFactura, onViewDoc }) {
