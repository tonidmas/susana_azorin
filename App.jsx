...
function emptySegundaMes() {
  return { fechaPagoRenta: "", fechaPagoLuz: "", fechaPagoAgua: "", ibiImporte: "", ibiFecha: "", reparacionesItems: [] };
}
    ...
    <>
      ...
      <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
        ...
        <div className="rg-form-grid">
          ...
          <div className="rg-field">
            <label className="rg-label">Fecha de pago de la luz</label>
          ...
          <div className="rg-field">
            <label className="rg-label">Fecha de pago del agua</label>
        ...
        <div style={{ fontSize: 11.5, color: "var(--text-dim)", marginTop: -6, marginBottom: 4 }}>
          La luz y el agua corren a cargo de la inquilina — se registran aquí solo para llevar el control de sus fechas de pago, no cuentan como gasto de la propiedad.
        </div>
      </div>
